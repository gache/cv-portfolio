...
export const translations: Record<Lang, T> = {
  fr: {
    ...
    contact: {
      ...
      availability: "Disponible pour des missions en ESN ou des postes en CDI dans les domaines de l'automatisation QA, du développement Java/Spring Boot ou de l'intégration IA.",
      basedIn: "Basé à Lille, France",
      openTo: "Ouvert au télétravail & hybride",
    },
    testimonials: {
      eyebrow: "Témoignages",
  ...
  en: {
    ...
    contact: {
      ...
      availability: "Available for consulting missions or permanent positions in QA automation, Java/Spring Boot development or AI integration.",
  ...
  es: {
    ...
    contact: {
      ...
      availability: "Disponible para misiones en ESN o puestos en CDI en QA automation, desarrollo Java/Spring Boot o integración de IA.",
